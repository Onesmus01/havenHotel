          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Create a new room listing with details and images</p>
              </div>
            </div>
            <button
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {/* Room Number - Explicitly text to accept G1, 101, etc. */}
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-1.5">
                <label className="text-sm font-medium text-slate-700">Room Images</label>
                <label className="flex flex-col items-center justify-center cursor-pointer bg-slate-50 border-2 border-dashed border-slate-300 rounded-xl p-6 hover:bg-slate-100 hover:border-amber-400 transition-all group">
                  ...
                  <span className="mt-2 text-sm font-medium text-slate-600 group-hover:text-slate-800">Click to upload images</span>
            ...
            {images.length > 0 && (
              <div className="mt-6">
                <p className="text-sm font-medium text-slate-700 mb-3">{images.length} image(s) selected</p>
          ...
          <div className="flex justify-end pb-10">
            <button
              type="submit"
              className="bg-slate-900 hover:bg-slate-800 text-white px-8 py-3.5 rounded-xl font-semibold transition shadow-lg hover:shadow-xl flex items-center gap-2 text-base"
            >
